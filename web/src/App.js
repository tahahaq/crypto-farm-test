...
class App extends React.PureComponent {
  ...
  closeAgreeDialog = () => {
    this.setState({ openAgree: false })
  }

  onAgreeClose = () => {
    this.setState({ openAgree: false, openWelcome: true })
  }
  ...
  render() {
    ...
    return (
      <>
        <Agreement onClose={this.closeAgreeDialog} open={this.state.openAgree} onClick={this.onAgreeClose} />
        <Welcome onClose={this.closeWelcomeDialog} open={this.state.openWelcome} />
        <div className="app">
