...
class Trade extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <div className="title" style={{ backgroundColor: "#191d52" }} >
          <div>
            <div style={{ color:"#e6dde9"}} >{currentMarket.id}</div>
            <div className="text-secondary">Make a Limit Order</div>
          </div>
        </div>
        <div className="trade flex-1 flex-column" style={{ backgroundColor: "#191d52" }} >
            ...
            <form
              ...
              <div>
                ...
                <div className="form-group">
                  <div className="form-title" style={{ color:"#e6dde9"}} >Order Summary</div>
                  <div className="list">
  ...
  renderField = ({ input, label, unit, meta, ...attrs }) => {
    ...
    return (
      <div className="form-group">
        <label style={{ color:"#e6dde9"}} >{label}</label>
        <div className="input-group">
          <input style={{ backgroundColor:"#101535"}} className="form-control" {...input} {...attrs} />
          <span style={{ color:"#e6dde9"}} className="text-secondary unit">{unit}</span>
        </div>
