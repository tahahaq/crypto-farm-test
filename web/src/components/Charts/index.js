...
class Charts extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="title flex justify-content-between align-items-center" style={{ backgroundColor: "#191d52" }} >
          <div>
            <div style={{ color:"#e6dde9"}} >Charts</div>
          </div>
        </div>

        <div className="flex-column flex-1 " style={{ backgroundColor: "#191d52" }} >
          <div className="grid flex-2" ref={this.tradeChartWrapper}>
            <TradeChart
              theme="dark"
              data={this.state.data}
              priceDecimals={5}
              styles={{ upColor: '#00d99f', downColor: '#ff6f75', background: '#101535' }}
          ...
          <div className="grid flex-1 border-top">
            <DeepChart
              baseToken="HOT"
              quoteToken="DAI"
              styles={{ bidColor: '#00d99f', askColor: '#ff6f75', rowBackgroundColor: '#101535' }}
              asks={asks}
              bids={bids}
              priceDecimals={5}
              theme="light"
