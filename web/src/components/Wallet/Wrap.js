...
class Wrap extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <form className="form flex-column text-secondary flex-1 justify-content-between block" style={{ backgroundColor: "#191d52" }} >
        <div className="form-group">
          <label className="text-secondary" style={{ color:"#e6dde9"}} >
