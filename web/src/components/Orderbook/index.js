...
class OrderBook extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="orderbook flex-column flex-1" style={{ backgroundColor:"#191d52"}} >
        <div className="flex header text-secondary" style={{ backgroundColor:"#101535"}} >
          <div className="col-6 text-right" style={{ color:"#e6dde9"}} >Amount</div>
          <div className="col-6 text-right" style={{ color: "#e6dde9" }} >Price</div>
        </div>
        <div className="flex-column flex-1">
          ...
          <div className="status border-top border-bottom" style={{ borderBottomColor:"#48518a"}} >
            {websocketConnected ? (
